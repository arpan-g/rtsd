...
// protected region RTlogger support end  
  ...
  LOGLOCAL(LOG_INFO, "Setting up a signal handler, press ctrl+c to stop newModel_deadlock.\n");
  ...
  LOGLOCAL(LOG_INFO, "Constructing the newModel_deadlock structure:\n");
...
// protected region manual tree modifications end  
  ...
  LOGLOCAL(LOG_INFO, "Starting newModel_deadlock - term thread: %p\n", term->getIThread());
  term->activate();
...
// protected region additional code end
  ...
  LOGLOCAL(LOG_INFO, "newModel_deadlock stopped.\n");
