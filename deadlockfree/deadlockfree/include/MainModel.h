...
private:
  ...
  // Channel definitions
  UnbufferedChannel<int, One2In, Out2One> *myProducer12POUT1to1_to_Consumer21C2IN1Channel;
  UnbufferedChannel<int, One2In, Out2One> *myProducer12POUT1to2_to_Consumer21C2IN2Channel;
