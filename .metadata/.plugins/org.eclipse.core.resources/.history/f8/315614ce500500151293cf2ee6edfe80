...
// protected region RTlogger support end  
  ...
  LOGLOCAL(LOG_INFO, "Setting up a signal handler, press ctrl+c to stop assignment3.\n");
  ...
  LOGLOCAL(LOG_INFO, "Constructing the assignment3 structure:\n");
...
// protected region manual tree modifications end  
  ...
  LOGLOCAL(LOG_INFO, "Starting assignment3 - term thread: %p\n", term->getIThread());
  term->activate();
...
// protected region additional code end
  ...
  LOGLOCAL(LOG_INFO, "assignment3 stopped.\n");
